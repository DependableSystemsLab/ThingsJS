...
describe('CodeEngine Test', function(){
	...
	describe('Single instance', function(){
		...
		before(function(done){
			...
			self.startupEngine = new things.CodeEngine({}, { mute_code_output: true });
			self.startupEngine.on('ready', done);
		});
		...
		it('runs code', function(done){
			...
			// return new Promise(function(resolve){
				self.startupEngine.run_code({ code_name: 'count.js', source: 'var c=0;setInterval(function(){ console.log(c++); }, 100)' })
