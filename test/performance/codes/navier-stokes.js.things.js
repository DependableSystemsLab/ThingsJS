(function(Σ) {
    ...
    function FluidField(canvas) {
        ...
        Σ_7.refs.uiCallback = Σ_7.addFunction(function αpPfc(d, u, v) {
            var Σ_7_10 = new Σ.Scope(this, αpPfc, '10', Σ_7, {
                d: d,
                u: u,
                v: v
            }, []);
        ...
        function Field(dens, u, v) {
            ...
            this.setDensity = Σ_7_11.addFunction(function αJiZp(x, y, d) {
                var Σ_7_11_0 = new Σ.Scope(this, αJiZp, '0', Σ_7_11, {
                    x: x,
                    y: y,
                    d: d
                }, []);
            ...
            this.getDensity = Σ_7_11.addFunction(function αQmSs(x, y) {
                var Σ_7_11_1 = new Σ.Scope(this, αQmSs, '1', Σ_7_11, {
                    x: x,
                    y: y
                }, []);
                return Σ_7_11.refs.dens[Σ_7_11_1.refs.x + 1 + (Σ_7_11_1.refs.y + 1) * Σ_7.refs.rowSize];
            }, Σ_7_11);
            this.setVelocity = Σ_7_11.addFunction(function αlurD(x, y, xv, yv) {
                var Σ_7_11_2 = new Σ.Scope(this, αlurD, '2', Σ_7_11, {
                    x: x,
                    y: y,
                    xv: xv,
                    yv: yv
            ...
            this.getXVelocity = Σ_7_11.addFunction(function α2HOI(x, y) {
                var Σ_7_11_3 = new Σ.Scope(this, α2HOI, '3', Σ_7_11, {
                    x: x,
                    y: y
                }, []);
                return Σ_7_11.refs.u[Σ_7_11_3.refs.x + 1 + (Σ_7_11_3.refs.y + 1) * Σ_7.refs.rowSize];
            }, Σ_7_11);
            this.getYVelocity = Σ_7_11.addFunction(function αQfDS(x, y) {
                var Σ_7_11_4 = new Σ.Scope(this, αQfDS, '4', Σ_7_11, {
                    x: x,
                    y: y
                }, []);
                return Σ_7_11.refs.v[Σ_7_11_4.refs.x + 1 + (Σ_7_11_4.refs.y + 1) * Σ_7.refs.rowSize];
            }, Σ_7_11);
            this.width = Σ_7_11.addFunction(function αoWT1() {
                var Σ_7_11_5 = new Σ.Scope(this, αoWT1, '5', Σ_7_11, {}, []);
                return Σ_7.refs.width;
            }, Σ_7_11);
            this.height = Σ_7_11.addFunction(function αnB7o() {
                var Σ_7_11_6 = new Σ.Scope(this, αnB7o, '6', Σ_7_11, {}, []);
        ...
        this.getDens = Σ_7.addFunction(function αPUVB() {
            var Σ_7_14 = new Σ.Scope(this, αPUVB, '14', Σ_7, {}, []);
            return Σ_7.refs.dens;
        }, Σ_7);
        this.setResolution = Σ_7.addFunction(function αJadl(hRes, wRes) {
            var Σ_7_15 = new Σ.Scope(this, αJadl, '15', Σ_7, {
                hRes: hRes,
                wRes: wRes
            }, []);
        ...
        this.update = Σ_7.addFunction(function αDZAL() {
            var Σ_7_16 = new Σ.Scope(this, αDZAL, '16', Σ_7, {}, []);
        ...
        this.setDisplayFunction = Σ_7.addFunction(function αVUfq(func) {
            var Σ_7_17 = new Σ.Scope(this, αVUfq, '17', Σ_7, {
                func: func
            }, []);
            Σ_7.refs.displayFunc = Σ_7_17.refs.func;
        }, Σ_7);
        this.iterations = Σ_7.addFunction(function α7ZM1() {
            var Σ_7_18 = new Σ.Scope(this, α7ZM1, '18', Σ_7, {}, []);
            return Σ_7.refs.iterations;
        }, Σ_7);
        this.setIterations = Σ_7.addFunction(function αR8gv(iters) {
            var Σ_7_19 = new Σ.Scope(this, αR8gv, '19', Σ_7, {
                iters: iters
            }, []);
        ...
        this.setUICallback = Σ_7.addFunction(function αUraQ(callback) {
            var Σ_7_20 = new Σ.Scope(this, αUraQ, '20', Σ_7, {
                callback: callback
            }, []);
    ...
    Σ.refs.performance = {};
    Σ.refs.performance.now = Σ.addFunction(function αI7qs() {
        var Σ_8 = new Σ.Scope(this, αI7qs, '8', Σ, {}, []);
        return Date.now();
    }, Σ);
