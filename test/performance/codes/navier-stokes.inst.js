(function(Σ) {
    ...
    function FluidField(canvas) {
        ...
        Σ_7.refs.uiCallback = Σ_7.addFunction(function αW0Ok(d, u, v) {
            var Σ_7_10 = new Σ.Scope(this, αW0Ok, '10', Σ_7, {
                d: d,
                u: u,
                v: v
            }, []);
        ...
        function Field(dens, u, v) {
            ...
            this.setDensity = Σ_7_11.addFunction(function αShN8(x, y, d) {
                var Σ_7_11_0 = new Σ.Scope(this, αShN8, '0', Σ_7_11, {
                    x: x,
                    y: y,
                    d: d
                }, []);
            ...
            this.getDensity = Σ_7_11.addFunction(function αkenj(x, y) {
                var Σ_7_11_1 = new Σ.Scope(this, αkenj, '1', Σ_7_11, {
                    x: x,
                    y: y
                }, []);
                return Σ_7_11.refs.dens[Σ_7_11_1.refs.x + 1 + (Σ_7_11_1.refs.y + 1) * Σ_7.refs.rowSize];
            });
            this.setVelocity = Σ_7_11.addFunction(function αRIvC(x, y, xv, yv) {
                var Σ_7_11_2 = new Σ.Scope(this, αRIvC, '2', Σ_7_11, {
                    x: x,
                    y: y,
                    xv: xv,
                    yv: yv
            ...
            this.getXVelocity = Σ_7_11.addFunction(function αYjDT(x, y) {
                var Σ_7_11_3 = new Σ.Scope(this, αYjDT, '3', Σ_7_11, {
                    x: x,
                    y: y
                }, []);
                return Σ_7_11.refs.u[Σ_7_11_3.refs.x + 1 + (Σ_7_11_3.refs.y + 1) * Σ_7.refs.rowSize];
            });
            this.getYVelocity = Σ_7_11.addFunction(function αKTao(x, y) {
                var Σ_7_11_4 = new Σ.Scope(this, αKTao, '4', Σ_7_11, {
                    x: x,
                    y: y
                }, []);
                return Σ_7_11.refs.v[Σ_7_11_4.refs.x + 1 + (Σ_7_11_4.refs.y + 1) * Σ_7.refs.rowSize];
            });
            this.width = Σ_7_11.addFunction(function αzukE() {
                var Σ_7_11_5 = new Σ.Scope(this, αzukE, '5', Σ_7_11, {}, []);
                return Σ_7.refs.width;
            });
            this.height = Σ_7_11.addFunction(function αrQLA() {
                var Σ_7_11_6 = new Σ.Scope(this, αrQLA, '6', Σ_7_11, {}, []);
        ...
        this.getDens = Σ_7.addFunction(function αYCUx() {
            var Σ_7_14 = new Σ.Scope(this, αYCUx, '14', Σ_7, {}, []);
            return Σ_7.refs.dens;
        });
        this.setResolution = Σ_7.addFunction(function αDKaY(hRes, wRes) {
            var Σ_7_15 = new Σ.Scope(this, αDKaY, '15', Σ_7, {
                hRes: hRes,
                wRes: wRes
            }, []);
        ...
        this.update = Σ_7.addFunction(function αGIpj() {
            var Σ_7_16 = new Σ.Scope(this, αGIpj, '16', Σ_7, {}, []);
        ...
        this.setDisplayFunction = Σ_7.addFunction(function αNDyZ(func) {
            var Σ_7_17 = new Σ.Scope(this, αNDyZ, '17', Σ_7, {
                func: func
            }, []);
            Σ_7.refs.displayFunc = Σ_7_17.refs.func;
        });
        this.iterations = Σ_7.addFunction(function α3kpl() {
            var Σ_7_18 = new Σ.Scope(this, α3kpl, '18', Σ_7, {}, []);
            return Σ_7.refs.iterations;
        });
        this.setIterations = Σ_7.addFunction(function αFOjJ(iters) {
            var Σ_7_19 = new Σ.Scope(this, αFOjJ, '19', Σ_7, {
                iters: iters
            }, []);
        ...
        this.setUICallback = Σ_7.addFunction(function αxbzS(callback) {
            var Σ_7_20 = new Σ.Scope(this, αxbzS, '20', Σ_7, {
                callback: callback
            }, []);
    ...
    Σ.refs.performance = {};
    Σ.refs.performance.now = Σ.addFunction(function αgn76() {
        var Σ_8 = new Σ.Scope(this, αgn76, '8', Σ, {}, []);
        return Date.now();
    });
    ...
    function BM_Start() {
        var Σ_9 = new Σ.Scope(this, BM_Start, '9', Σ, {}, [doRun]);
        Σ.refs.BM_SetupFunc();
        Σ_9.refs.data = {
            runs: 0,
            elapsed: 0
