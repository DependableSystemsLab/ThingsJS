(function(Σ) {
    ...
    Σ.refs.SplayTree.prototype.isEmpty = Σ.addFunction(function α2Iuy() {
        var Σ_9 = new Σ.Scope(this, α2Iuy, '9', Σ, {}, []);
        return !this.root_;
    }, Σ);
    Σ.refs.SplayTree.prototype.insert = Σ.addFunction(function αNgNB(key, value) {
    ...
    Σ.refs.SplayTree.prototype.remove = Σ.addFunction(function αggjP(key) {
    ...
    Σ.refs.SplayTree.prototype.find = Σ.addFunction(function α7WcO(key) {
    ...
    Σ.refs.SplayTree.prototype.findMax = Σ.addFunction(function αXJyG(opt_startNode) {
    ...
    Σ.refs.SplayTree.prototype.findGreatestLessThan = Σ.addFunction(function αIkhF(key) {
    ...
    Σ.refs.SplayTree.prototype.exportKeys = Σ.addFunction(function αJOZ4() {
    ...
    Σ.refs.SplayTree.prototype.splay_ = Σ.addFunction(function αeVIv(key) {
    ...
    Σ.refs.SplayTree.Node = Σ.addFunction(function αuUOY(key, value) {
    ...
    Σ.refs.SplayTree.Node.prototype.traverse_ = Σ.addFunction(function αd1xm(f) {
    ...
    Σ.refs.performance = {};
    Σ.refs.performance.now = Σ.addFunction(function αMb8u() {
