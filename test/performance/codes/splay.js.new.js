(function(Σ) {
    ...
    Σ.refs.kSplayTreeModifications = 40;
    Σ.refs.kSplayTreePayloadDepth = 4;
    ...
    Σ.refs.SplayTree.prototype.isEmpty = Σ.addFunction(function αMhuk() {
        var Σ_9 = new Σ.Scope(this, αMhuk, '9', Σ, {}, []);
        return !this.root_;
    }, Σ);
    Σ.refs.SplayTree.prototype.insert = Σ.addFunction(function αgWHJ(key, value) {
        var Σ_10 = new Σ.Scope(this, αgWHJ, '10', Σ, {
            key: key,
            value: value
        }, []);
        if (this.isEmpty()) {
    ...
    Σ.refs.SplayTree.prototype.remove = Σ.addFunction(function α2RJF(key) {
        var Σ_11 = new Σ.Scope(this, α2RJF, '11', Σ, {
            key: key
        }, []);
        if (this.isEmpty()) {
    ...
    Σ.refs.SplayTree.prototype.find = Σ.addFunction(function αI3xG(key) {
        var Σ_12 = new Σ.Scope(this, αI3xG, '12', Σ, {
            key: key
        }, []);
        if (this.isEmpty()) {
            return null;
    ...
    Σ.refs.SplayTree.prototype.findMax = Σ.addFunction(function αGy2m(opt_startNode) {
        var Σ_13 = new Σ.Scope(this, αGy2m, '13', Σ, {
    ...
    Σ.refs.SplayTree.prototype.findGreatestLessThan = Σ.addFunction(function αPvXj(key) {
        var Σ_14 = new Σ.Scope(this, αPvXj, '14', Σ, {
            key: key
        }, []);
        if (this.isEmpty()) {
            return null;
    ...
    Σ.refs.SplayTree.prototype.exportKeys = Σ.addFunction(function αGCxi() {
        var Σ_15 = new Σ.Scope(this, αGCxi, '15', Σ, {}, []);
        Σ_15.refs.result = [];
        if (!this.isEmpty()) {
            this.root_.traverse_(Σ_15.addFunction(function αnJrQ(node) {
                var Σ_15_0 = new Σ.Scope(this, αnJrQ, '0', Σ_15, {
                    node: node
                }, []);
    ...
    Σ.refs.SplayTree.prototype.splay_ = Σ.addFunction(function αBJ7M(key) {
        var Σ_16 = new Σ.Scope(this, αBJ7M, '16', Σ, {
            key: key
        }, []);
        if (this.isEmpty()) {
            return;
    ...
    Σ.refs.SplayTree.Node = Σ.addFunction(function αe8bs(key, value) {
        var Σ_17 = new Σ.Scope(this, αe8bs, '17', Σ, {
            key: key,
            value: value
        }, []);
    ...
    Σ.refs.SplayTree.Node.prototype.traverse_ = Σ.addFunction(function αMDAx(f) {
        var Σ_18 = new Σ.Scope(this, αMDAx, '18', Σ, {
            f: f
        }, []);
    ...
    Σ.refs.performance = {};
    Σ.refs.performance.now = Σ.addFunction(function αgazM() {
        var Σ_19 = new Σ.Scope(this, αgazM, '19', Σ, {}, []);
        return Date.now();
    }, Σ);
