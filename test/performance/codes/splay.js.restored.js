(function(Σ) {
    ...
    Σ.addFunction(function α2Iuy() {
        var Σ_9 = new Σ.Scope(this, α2Iuy, '9', Σ, {}, []);
        return !this.root_;
    }, Σ, "α2Iuy.OeGuxr");
    Σ.addFunction(function αNgNB(key, value) {
    ...
    Σ.addFunction(function αggjP(key) {
    ...
    Σ.addFunction(function α7WcO(key) {
    ...
    Σ.addFunction(function αXJyG(opt_startNode) {
    ...
    Σ.addFunction(function αIkhF(key) {
    ...
    Σ.addFunction(function αeVIv(key) {
    ...
    Σ.addFunction(function αuUOY(key, value) {
    ...
    Σ.addFunction(function αd1xm(f) {
    ...
    (function BM_Start() {
        ...
        Σ_20.refs.doRun = Σ.getFunction("20_uVX7/doRun");
        Σ_20.refs.data = {
            runs: 0,
            elapsed: 0
        };
        Σ_20.refs.elapsed = 7855;
        Σ_20.refs.start = 1523560311666;
        Σ_20.refs.end = null;
        Σ_20.refs.i = 51;
    }());
    Σ.funcs["SplayTree"].prototype.root_ = null;
    Σ.funcs["SplayTree"].prototype.isEmpty = Σ.getFunction("α2Iuy.OeGuxr");
    Σ.funcs["SplayTree"].prototype.insert = Σ.getFunction("αNgNB.KfeZOG");
    Σ.funcs["SplayTree"].prototype.remove = Σ.getFunction("αggjP.W7J0AA");
    Σ.funcs["SplayTree"].prototype.find = Σ.getFunction("α7WcO.7Sf8DZ");
    Σ.funcs["SplayTree"].prototype.findMax = Σ.getFunction("αXJyG.r5HNEu");
    Σ.funcs["SplayTree"].prototype.findGreatestLessThan = Σ.getFunction("αIkhF.gZsmCo");
    Σ.funcs["SplayTree"].prototype.exportKeys = Σ.getFunction("αJOZ4.NBRiK2");
    Σ.funcs["SplayTree"].prototype.splay_ = Σ.getFunction("αeVIv.Ypo2mw");
    Σ.wrapped["SplayTree"].Node = Σ.funcs["SplayTree"].Node = Σ.getFunction("αuUOY.ijA0DO");
    Σ.refs.GeneratePayloadTree = Σ.getFunction("GeneratePayloadTree");
    Σ.refs.GenerateKey = Σ.getFunction("GenerateKey");
    Σ.refs.SplayRMS = Σ.getFunction("SplayRMS");
    Σ.refs.SplayUpdateStats = Σ.getFunction("SplayUpdateStats");
    Σ.refs.InsertNewNode = Σ.getFunction("InsertNewNode");
    Σ.refs.SplaySetup = Σ.getFunction("SplaySetup");
    Σ.refs.SplayTearDown = Σ.getFunction("SplayTearDown");
    Σ.refs.SplayRun = Σ.getFunction("SplayRun");
    Σ.refs.SplayTree = Σ.getFunction("SplayTree");
    Σ.refs.BM_Start = Σ.getFunction("BM_Start");
    Σ.refs.kSplayTreeSize = 1000;
    Σ.refs.kSplayTreeModifications = 10;
    Σ.refs.kSplayTreePayloadDepth = 3;
    Σ.refs.splayTree = null;
    Σ.refs.splaySampleTimeStart = 1523560319521;
    Σ.refs.splaySamples = 0;
    Σ.refs.splaySumOfSquaredPauses = 0;
    Σ.refs.performance = {
        now: Σ.getFunction("αMb8u.f4j4Gp")
    };
    ...
    Σ.refs.BM_Results = [];
    Σ.setImmediate(Σ.getFunction("20_uVX7/doRun"), "K1fYr7oH");
