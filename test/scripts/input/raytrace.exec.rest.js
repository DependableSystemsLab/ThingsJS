/* This Benchmark was modified;
   it contains code injected to handle the edge-case of
   not migrating native objects that have been augmented.
   e.g. Object.extend = function(){}    the extend function is not migrated.

   This caused one of the objects to have a missing .wrapUp method,
   which has been manually copy-pasted here.
 */
