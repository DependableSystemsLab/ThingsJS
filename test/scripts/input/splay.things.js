(function(Σ) {
    ...
    Σ.refs.SplayTree.prototype.isEmpty = Σ.addFunction(function αwrDU() {
        var Σ_9 = new Σ.Scope(this, αwrDU, '9', Σ, {}, []);
        return !this.root_;
    }, Σ);
    Σ.refs.SplayTree.prototype.insert = Σ.addFunction(function αRMCN(key, value) {
        var Σ_10 = new Σ.Scope(this, αRMCN, '10', Σ, {
            key: key,
            value: value
        }, []);
        if (this.isEmpty()) {
    ...
    Σ.refs.SplayTree.prototype.remove = Σ.addFunction(function α7KQI(key) {
        var Σ_11 = new Σ.Scope(this, α7KQI, '11', Σ, {
            key: key
        }, []);
        if (this.isEmpty()) {
    ...
    Σ.refs.SplayTree.prototype.find = Σ.addFunction(function αNDqq(key) {
        var Σ_12 = new Σ.Scope(this, αNDqq, '12', Σ, {
            key: key
        }, []);
        if (this.isEmpty()) {
            return null;
    ...
    Σ.refs.SplayTree.prototype.findMax = Σ.addFunction(function αqgDE(opt_startNode) {
        var Σ_13 = new Σ.Scope(this, αqgDE, '13', Σ, {
    ...
    Σ.refs.SplayTree.prototype.findGreatestLessThan = Σ.addFunction(function αoQ8D(key) {
        var Σ_14 = new Σ.Scope(this, αoQ8D, '14', Σ, {
            key: key
        }, []);
        if (this.isEmpty()) {
            return null;
    ...
    Σ.refs.SplayTree.prototype.exportKeys = Σ.addFunction(function αxi2H() {
        var Σ_15 = new Σ.Scope(this, αxi2H, '15', Σ, {}, []);
        Σ_15.refs.result = [];
        if (!this.isEmpty()) {
            this.root_.traverse_(Σ_15.addFunction(function αBdrU(node) {
                var Σ_15_0 = new Σ.Scope(this, αBdrU, '0', Σ_15, {
                    node: node
                }, []);
    ...
    Σ.refs.SplayTree.prototype.splay_ = Σ.addFunction(function α9rfF(key) {
        var Σ_16 = new Σ.Scope(this, α9rfF, '16', Σ, {
            key: key
        }, []);
        if (this.isEmpty()) {
            return;
    ...
    Σ.refs.SplayTree.Node = Σ.addFunction(function αyfVc(key, value) {
        var Σ_17 = new Σ.Scope(this, αyfVc, '17', Σ, {
            key: key,
            value: value
        }, []);
    ...
    Σ.refs.SplayTree.Node.prototype.traverse_ = Σ.addFunction(function αUX46(f) {
        var Σ_18 = new Σ.Scope(this, αUX46, '18', Σ, {
            f: f
        }, []);
    ...
    Σ.refs.performance = {};
    Σ.refs.performance.now = Σ.addFunction(function αFSfM() {
        var Σ_19 = new Σ.Scope(this, αFSfM, '19', Σ, {}, []);
        return Date.now();
    }, Σ);
