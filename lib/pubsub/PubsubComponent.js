...
PubsubComponent.prototype.reconfigure=function(topic,address,topicCallbackHandler){
	var self=this
	...
	if(!self.handlers.has(topic)&& self.pubsub_url==address){
		...
		multilogger.log('['+self.name+']'+"Reconfiguring topic : "+topic+' Subscribing to '+address)
	}
