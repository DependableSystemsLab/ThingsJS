...
Code.fromSnapshot = function(snapshot){
	// console.log(chalk.blue('Restoring from Snapshot'));
...
Scope.prototype.addFunction = function(func, protects, uid){
	...
	var wrapped = function(){
		...
		if (this instanceof wrapped){
			// console.log(this);
			result = new (func.bind.apply(func, arguments));
			// console.log(result);
			return result;
		}
		else result = func.apply(this, arguments);
	...
	Object.keys(func).forEach(function(prop){ wrapped[prop] = func[prop] });
	...
	// wrapped[PROPERTY_PREFIX+'uri'] = func[PROPERTY_PREFIX+'uri'];
	// wrapped[PROPERTY_PREFIX+'protects'] = func[PROPERTY_PREFIX+'protects'];
	// wrapped[PROPERTY_PREFIX+'parent'] = func[PROPERTY_PREFIX+'parent'];
