...
Code.instrument = function(pubsub, code_name, raw_code){
	...
	var template_str = `require('things-js').bootstrap(module, function(${SCOPE_PREFIX}){}, '${pubsub.url}', '${code_name}', ${meta});`;
...
Code.fromSnapshot = function(snapshot, dummy_pubsub){
	...
	code.source = `require('things-js').bootstrap(module, function(${SCOPE_PREFIX}){ ${content} }, '${code.pubsub.url}', '${snapshot.meta.code_name}/${snapshot.meta.instance_id}', ${meta});`;
